            ...
            <table class="table table-bordered table-hover">
                ...
                <?php
                    ...
                    while($row = mysqli_fetch_assoc($query_run)){
                        ...
                        <td><button onclick="window.location.href='edit_author.php?aid=<?php echo $row['author_id'];?>';" class="btn btn-primary" name="" href="edit_author.php">Edit</button>
                        <button onclick="window.location.href='delete_author.php?aid=<?php echo $row['author_id'];?>';" class="btn btn-danger" name="" href="delete_author.php">Delete</button>
