            ...
            <table class="table table-bordered table-hover">
                ...
                <?php
                    ...
                    while($row = mysqli_fetch_assoc($query_run)){
                        ...
                        <td><button onclick="window.location.href='edit_book.php?bn=<?php echo $row['book_no'];?>';" class="btn btn-primary" name="" href="edit_book.php">Edit</button>
                        <button onclick="window.location.href='delete_book.php?bn=<?php echo $row['book_no'] ;?>';" class="btn btn-danger" name="" href="delete_book.php">Delete</button>
                        </tr>
                        <?php
