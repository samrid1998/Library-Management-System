            ...
            <table class="table table-bordered table-hover">
                ...
                <?php
                    ...
                    while($row = mysqli_fetch_assoc($query_run)){
                        ...
                        <td><button onclick="window.location.href='edit_category.php?cid=<?php echo $row['category_id'];?>';" class="btn btn-primary" name="" href="edit_book.php">Edit</button>
                        <button onclick="window.location.href='delete_category.php?cid=<?php echo $row['category_id'];?>';" class="btn btn-danger" name="" href="delete_book.php">Delete</button>
